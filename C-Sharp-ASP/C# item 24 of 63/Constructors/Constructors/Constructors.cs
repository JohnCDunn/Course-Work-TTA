...
namespace Constructors
{
    class Animal
    {
        ...
        public Animal()
        {
            ...
            numOfAnimals++;
            Console.WriteLine("Creating a default Animal constructor here");
        }
        ...
        public Animal(double height, double weight, string name, string sound)
        {
            ...
            numOfAnimals++;
            Console.WriteLine("Creating a Custom Animal constructor here");
        }
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Creating an Animal object and calling the constructor");
