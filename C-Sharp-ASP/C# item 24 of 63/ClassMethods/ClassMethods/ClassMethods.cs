...
namespace ClassMethods
{
    class Animal
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("We are calling the getNumOfAnimals method here");
            Console.WriteLine("Number of Animals " + Animal.getNumOfAnimals());

            // Calling an object method
            Console.WriteLine("We are calling the toString method here");
            Console.WriteLine(spot.toString());

            Console.WriteLine("We are calling the getSum method here");
