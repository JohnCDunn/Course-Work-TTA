...
{
    // two classes using getters and setters
    class Animal
    {
        ...
        public Animal()
        {
            Console.WriteLine("Set initial values for fields defined in the Animal class");
            this.height = 0;
            this.weight = 0;
            this.name = "No Name";
            this.sound = "No Sound";
        ...
        {
            Console.WriteLine("Get values for fields defined in the Animal class");
    ...
    class Dog : Animal
    {
        ...
        {
            Console.WriteLine("Get values for the fields defined in the Animal Class");
