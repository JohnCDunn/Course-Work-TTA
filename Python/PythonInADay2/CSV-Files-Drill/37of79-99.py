...
class Frame(wx.Frame):
    def __init__(self, title):
        ...
        listCtrl = wx.ListCtrl(panel, size=(400,400), pos=(350,40), style=wx.LC_REPORT |wx.BORDER_SUNKEN)

        # Add columns to listCtrl
        listCtrl.InsertColumn(0, "ID")
        listCtrl.InsertColumn(1, "Name")
        listCtrl.InsertColumn(2, "Gender")
        listCtrl.InsertColumn(3, "Age")
        listCtrl.InsertColumn(4, "Occupation")
